...
(function($){
    ...
    const converter = markdownit({html:true}).use(tm, {delimiters:'dollars'});
            ...
            setupQuiz: function(options) { // use 'options' object to pass args
                ...
                for (i in questions) {
                    if (questions.hasOwnProperty(i)) {
                        ...
                        questionHTML.append(converter.render(question.q));
                        ...
                        var answerHTML = $('<ol class="' + answersClass + '" type="A"></ol>');
                        ...
                        for (i in answers) {
                            if (answers.hasOwnProperty(i)) {
                                ...
                                var optionLabel = '<label for="' + optionId + '">' + converter.render(answer.option) + '</label>';
